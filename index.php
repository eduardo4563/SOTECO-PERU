...
<head>
  ...
  <link rel="stylesheet" href="cssIndex.css?200">
...
<script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "SOTECO PERÚ S.A.C.",
  "url": "https://sotecoperu.com",
  "logo": "https://www.sotecoperu.com/img/image_no_bg.png",
   "description": "SOTECO PERÚ S.A.C. - Soluciones tecnológicas con más de 15 años de experiencia en hardware, software y servicios IT.",
  "contactPoint": {
    "@type": "ContactPoint",
    "telephone": "+51 997 165 701",
...
<body>
  ...
  <div class="fondo">
    ...
    <div class="esencia-overlay">
      <h1 data-aos="zoom-in">Bienvenido a <span>SOTECO PERÚ S.A.C.</span></h1>
      <p>Soluciones tecnológicas con 15 años de experiencia y calidad garantizada.</p>
      <a href="https://wa.me/51941797953?text=Hola%20SOTECO%20PERÚ,%20quiero%20cotizar%20un%20producto." target="_blank" class="btn-cotizaahora" data-aos="flip-left" data-aos-delay="500">Cotiza ahora</a>
      <a href="https://wa.me/51941797953?text=Hola%20SOTECO%20PERÚ,%20quiero%20un%20presupuesto%20gratis%20para%20mi%20empresa." target="_blank" class="btn-presupuesto" data-aos="flip-right" data-aos-delay="600">Pide tu presupuesto GRATIS</a>
    </div>
  </div>
  ...
  <section>
    <div class="sobre-nosotros" data-aos="fade-up">
      <h2 data-aos="zoom-in">¿Quiénes Somos?</h2>
      <p data-aos="fade-left">En SOTECO PERÚ impulsamos la transformación digital con innovación, calidad y compromiso. Brindamos soluciones
        integrales en hardware, software y servicios tecnológicos para empresas y personas.</p>
      <a href="quienessomos.php#quienesSomos" class="btn-conocenos" data-aos="flip-up" data-aos-delay="300">Más sobre nosotros</a>
    </div>
  </section>

  <!-- Qué ofrecemos -->
  <section class="ofrecemos" data-aos="fade-right">
    <h2 data-aos="zoom-in">¿Qué ofrecemos?</h2>
    <p data-aos="fade-left">Soluciones integrales en tecnología para empresas y personas.</p>
    ...
    <a href="servicios.php" class="btn-conocenos2" data-aos="slide-up" data-aos-delay="500">Ver todos los servicios</a>
  </section>

  <!-- Beneficios -->
  <section id="beneficios" data-aos="fade-up">
    <h2 data-aos="zoom-in">¿Por qué elegirnos?</h2>
    <div class="beneficios">
      <div class="beneficio-card" data-aos="flip-left" data-aos-delay="100">
        <div class="icono"><img src="img/agente-de-servicio-al-cliente.webp" alt="Atención personalizada"></div>
        <h3>Atención personalizada</h3>
        <p>Nos enfocamos en tus necesidades específicas y te damos soluciones reales.</p>
      </div>
      <div class="beneficio-card" data-aos="flip-up" data-aos-delay="200">
        <div class="icono"><img src="img/ventas.webp" alt="Precios competitivos"></div>
        <h3>Precios competitivos</h3>
        <p>Te ofrecemos la mejor relación calidad-precio del mercado.</p>
      </div>
      <div class="beneficio-card" data-aos="flip-right" data-aos-delay="300">
        <div class="icono"><img src="img/insignia.webp" alt="Soporte técnico"></div>
        <h3>Soporte técnico calificado</h3>
        <p>Contamos con profesionales expertos siempre listos para ayudarte.</p>
      </div>
      <div class="beneficio-card" data-aos="zoom-in-up" data-aos-delay="400">
        <div class="icono"><img src="img/proteccion-de-envio.webp" alt="Entregas rápidas"></div>
  ...
  <div class="contenedor-claro esencia2" style="display:none;" data-aos="fade-up">
    <section class="seccion-ofertas">
      <h2 style="text-align: center;" data-aos="zoom-in">Productos en Oferta</h2>
      <div class="contenedor-carrusel" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="vista-galeria">
          <div class="galeria-ofertas" id="galeriaOfertas">
            <!-- tarjetas de producto (puedes añadir más con data-aos="zoom-in" y delays) -->
            <div class="tarjeta-producto" data-aos="zoom-in" data-aos-delay="100">
  ...
  <div id="beneficioss" data-aos="fade-up">
    <h2 class="titulo1" data-aos="zoom-in">Categorías</h2>
    <div class="categorias">
      <a href="productos.php" style="text-decoration: none;color: #e2e8f0;">
        <div class="categoria" data-aos="slide-right" data-aos-delay="100">
      ...
      <a href="servicios.php" style="text-decoration: none;color: #e2e8f0;">
        <div class="categoria" data-aos="slide-left" data-aos-delay="200">
  ...
  <section class="novedades-modernas" data-aos="fade-up">
    <h2 class="titulo-novedades" data-aos="zoom-in">Novedades Tecnológicas</h2>
    <div class="grid-novedades">
      <div class="card-novedad" data-aos="fade-right" data-aos-delay="100">
        <img src="img/Gemini_Generated_Image_emqrkaemqrkaemqr.webp" alt="Teclado Mecánico RGB">
      ...
      <div class="card-novedad" data-aos="fade-up" data-aos-delay="200">
        <img src="img/Gemini_Generated_Image_emqrkaemqrkaemqr-_1_.webp" alt="Laptop Gamer Nitro 2025">
        <div class="contenido-novedad">
      ...
      <div class="card-novedad" data-aos="fade-left" data-aos-delay="300">
        <img src="img/Gemini_Generated_Image_9xl4oa9xl4oa9xl4.webp" alt="Webcam Full HD">
        <div class="contenido-novedad">
  ...
  <section class="blog-tecnologia" data-aos="fade-up">
    <h2 class="titulo-blog" data-aos="zoom-in">Noticias Tecnológicas</h2>
    <div class="blog-container">
      <div class="blog-card" data-aos="flip-left" data-aos-delay="100">
        <div class="blog-icon icon-azul"><i class="fas fa-laptop-code"></i></div>
        <h3>Top 5 laptops 2025</h3>
        <p>Conoce los mejores modelos...</p>
        <a href="blog.php" class="btn-leer">Leer más <i class="fas fa-arrow-right"></i></a>
      </div>
      <div class="blog-card" data-aos="flip-right" data-aos-delay="200">
        <div class="blog-icon icon-rojo"><i class="fas fa-desktop"></i></div>
        <h3>¿PC gamer o empresarial?</h3>
        <p>Guía rápida para elegir tu próxima computadora...</p>
        <a href="blog.php" class="btn-leer">Leer más <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
  </section>
  ...
  <section class="testimonials-section" data-aos="fade-up">
    <h2 data-aos="zoom-in">Clientes satisfechos</h2>
    <div class="carousel" data-aos="slide-up" data-aos-delay="200">
      <div class="carousel-track">
        <div class="testimonial" data-aos="fade-right" data-aos-delay="100">
          ...
          <p>"Gracias a SOTECO Perú..."</p>
          <span>— Carlos R., Administrador</span>
        </div>
  ...
  <div class="popup-newsletter" id="popupNewsletter" data-aos="zoom-in">
